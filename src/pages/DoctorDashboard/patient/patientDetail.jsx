            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                {recentMedications.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500">Không có đơn thuốc hiện tại</p>
                )}
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Link
                      to={`/doctor/patients/${patientId}/tests`}
                      className="bg-purple-600 text-white text-sm font-medium py-2 px-3 rounded-md hover:bg-purple-700 transition flex items-center justify-center"
                    >
                      <svg className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
